...
if __name__ == "__main__":
    print("Generating Figure 4: Experimental Protocols...")
    print("SRV, CDAE, STEA, and PSTA/ESTA Protocol Visualization")

    # Resolve output directory to plots
    plots_dir = Path("../plots")
    plots_dir.mkdir(exist_ok=True)

    # Generate comprehensive protocols diagram for canonical export
    fig_full, ax_full = create_comprehensive_protocols()
    fig_full.savefig(str(plots_dir / 'fig4_experimental_protocols_v1.pdf'), dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
    fig_full.savefig(str(plots_dir / 'fig4_experimental_protocols_v1.png'), dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
    print("Saved: fig4_experimental_protocols_v1.pdf")

    # Generate simplified flowchart
    fig_flow, ax_flow = create_protocol_flowchart()
    fig_flow.savefig(str(plots_dir / 'fig4_protocol_flowchart_v1.pdf'), dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
    fig_flow.savefig(str(plots_dir / 'fig4_protocol_flowchart_v1.png'), dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
    print("Saved: fig4_protocol_flowchart_v1.pdf")

    # Overview (compact) export
    fig_over, ax_over = create_comprehensive_protocols()
    fig_over.set_size_inches(7.8, 5.2)
    fig_over.savefig(str(plots_dir / 'fig4_experimental_overview_v1.pdf'), dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none', pad_inches=0.06)
    fig_over.savefig(str(plots_dir / 'fig4_experimental_overview_v1.png'), dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none', pad_inches=0.06)
    print("Saved: fig4_experimental_overview_v1.pdf")
